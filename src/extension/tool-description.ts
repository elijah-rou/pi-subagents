...
const HUMAN_ADMINISTRATION_GUIDANCE = "Supported human administration uses /subagents for agent authoring, /subagents-refine, the profile slash commands, and /subagents-fleet. Trusted RPC retains only passive legacy schedule list/show/history readers for one release. Missions, schedule execution, lane merge/supersession, broad cleanup, and panes have no supported replacement pending Package 3.";
