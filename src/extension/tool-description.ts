...
const HUMAN_ADMINISTRATION_GUIDANCE = "Supported human administration uses /subagents for agent authoring, /subagents-refine, /subagents-watchdog, the profile slash commands, /subagents-fleet, and current RPC schedule management. Missions, lane merge/supersession, broad cleanup, and panes have no supported replacement pending Packages 2 and 3.";
